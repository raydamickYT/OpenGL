...
{
    // Initialiseer hier de vertices en indices voor de kubus.
    vertices = {
...
void CubeCreator::createCube(GLuint& VAO, GLuint& EBO, int& size, int& numIndices)
{
    int stride = (17) * sizeof(float);

    size = vertices.size() / (stride / sizeof(float));
